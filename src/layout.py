...
navbar = dbc.NavbarSimple(
    children=[
        ...
        dbc.NavLink(html.Img(src=app.get_asset_url('resume_image.png'),style={'height':'75%', 'width':'18%'}), href='https://drive.google.com/file/d/17qtug8J03bfkH7Fx2P_W9mr3EPNSN9ZW/view?usp=sharing', className='lead'),
